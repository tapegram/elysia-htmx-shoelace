        ...
        <sl-animation name="pulse" duration="500" iterations="1" easing="easeOutCubic">
          <sl-details
            _="on focus add @play to the closest <sl-animation />
               ...
               on keyup if the event's key is 'd' call alert('delete') end
          ...
          >
            ...
            <div class="flex gap-2 justify-end mt-2">
              <sl-button tabindex={-1} variant="danger" onclick="alert('delete')">Delete</sl-button>
              <sl-button tabindex={-1} variant="primary" onclick="alert('completed')">Done</sl-button>
            </div>
          </sl-details>
        </sl-animation>
      ))
